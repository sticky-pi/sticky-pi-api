...
class LocalAndRemoteTests(object):
    ...
    def _clean_persistent_resources(self, cli):
        ...
        cli.delete_projects(all_projects)
    ...
    def test_projects(self):
        ...
        try:
            ...
            out = cli.put_project_series([{"project_id": test_project_id, "device":"0123abcd",
                                           "start_datetime":"2021-01-01T12:12:12Z", "end_datetime":"2021-01-12T12:12:12Z"},
                                    {"project_id": test_project_id , "device": "cdef1234",
                                     "start_datetime": "2021-01-01T12:12:14Z", "end_datetime": "2021-01-12T12:12:30Z"}
                                    ],
                                         client_info=grace)
